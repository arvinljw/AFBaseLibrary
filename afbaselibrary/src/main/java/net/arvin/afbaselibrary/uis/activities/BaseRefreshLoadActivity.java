...
/**
 * Created by arvinljw on 17/5/11 21:13
 * Function：下拉刷新，上拉加载
 ...
 * 3、列表只支持上拉加载；
 */
public abstract class BaseRefreshLoadActivity<T> extends BaseRefreshActivity implements OnLoadMoreListener, BaseQuickAdapter.OnItemClickListener {
    ...
    protected void initRecyclerView() {
        ...
        mRecyclerView = findViewById(getRecyclerViewId());
        setLayoutManager();
        setAdapter();
        addDivider();
    }
